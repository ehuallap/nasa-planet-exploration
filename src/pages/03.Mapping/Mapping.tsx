...
const Mapping = () => {
    ...
    return (
        <div className='container-mapping'>
            ...
            />
            <Planet top="40%" left='46%' size={180} earthTextureURL={centauriBTextureURl}/>
            <Planet top="15%" left='20%' size={150}  earthTextureURL={centauriCTextureURL}/>
            <Planet top="50%" left='15%' size={250}  earthTextureURL={centauriCTextureURL}/>
        </div>
    );
}
