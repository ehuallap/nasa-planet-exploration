...
const Video = ({ videoId }) => {
    ...
    return (_jsxs("div", { id: "video-container", style: {
        ...
        }, children: [_jsx("iframe", { ref: iframeRef, width: "100%", height: "100%", src: `https://www.youtube.com/embed/${videoId}?autoplay=1`, title: "YouTube video player", frameBorder: "0", allow: "autoplay; encrypted-media", allowFullScreen: true, style: {
                    border: 'none', // Sin borde
                    borderRadius: '8px', // Ajusta el estilo según sea necesario
                } }), _jsx("button", { onClick: handleBack, style: {
                    position: 'absolute',
                    top: '80%',
                    left: '50%',
